        ...
        var acornPlayer = function () {
            ...
            var initVolume = function () {
                if (options.nativeSliders) {
                    ...
                    var divVolume = '<div class="' + volumeClass + '" title="' + text.volumeTitle + '"tabindex="4"><img src="images/triangleBlue.png" style="position:absolute;"/><img src="images/backgroundVolume.png" style="position: absolute;z-index: -1;cursor: default;"/></div>';
