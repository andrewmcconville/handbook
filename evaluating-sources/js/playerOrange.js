    ...
    $.fn.acornMediaPlayer = function (options) {
        ...
        var acornPlayer = function () {
            ...
            var text = {
                ...
                decreaseTitle: 'press minus to lower volume',
                increaseTitle: 'press plus to increase volume',
            ...
            var initVolume = function () {
                if (options.nativeSliders) {
                    ...
                    var divVolume = '<div class="' + volumeClass + '" title="' + text.volumeTitle + '"tabindex="6"><img src="images/triangleOrange.png" style="position:absolute;"/><img src="images/backgroundVolume.png" style="position: absolute;z-index: -1;cursor: default;"/></div>';
